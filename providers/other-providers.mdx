...
description: Support for z.ai, Kimi, Kilo, Kimi K2, Kiro, Vertex AI, Augment, Amp, JetBrains AI, OpenRouter, Antigravity, and Droid/Factory
---
...
<CardGroup cols={2}>
  <Card title="Configure Multiple Providers" icon="layer-group" href="/configuration">
